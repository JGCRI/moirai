...
* ldsdestpath: path to directory where the eight LDS output data files will be copied to (e.g., …/aglu-data/LDS; this directory must already exist)
* mapdestpath: path to directory where the two LDS output mapping files will be copied to (e.g., …/aglu-data/mappings; this directory must already exist)
