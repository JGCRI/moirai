...
create_carbon_plots_veg_carbon_below_ground(
  fig_dir  = "carbon_plots/",
                                   ...
                                   basin_name = "Missouri_River_Basin",
                                   carbon_year = 2010,
                                   carbon_raster_file_names =c("veg_BG_weighted_average.bil",                                                                "veg_BG_q1.bil",                                                                             "veg_BG_carbon_median.bil",                                                                   "veg_BG_carbon_min.bil",                                                                      "veg_BG_carbon_q3.bil",                                                                         "veg_BG_carbon_max.bil"),
                                   print_raster_progress_log =FALSE
)
