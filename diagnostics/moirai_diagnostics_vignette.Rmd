...
compare_iso_land_data(path_to_Original_LDS_Data = "../outputs/basins235_test_new_protected/Land_type_area_ha.csv",
                                  path_to_Updated_LDS_Data = "../outputs/basins235_test_new_protected/Land_type_area_ha.csv",
                                  path_to_old_mapping = "../outputs/basins235_test_new_protected/MOIRAI_land_types.csv",
...
compare_iso_glu_land_data(path_to_Original_LDS_Data = "../outputs/basins235_test_new_protected/Land_type_area_ha.csv",
                                  path_to_Updated_LDS_Data = "../outputs/basins235_test_new_protected/Land_type_area_ha.csv",
                                  path_to_old_mapping = "../outputs/basins235_test_new_protected/MOIRAI_land_types.csv",
                                  path_to_new_mapping = "../outputs/basins235_test_new_protected/MOIRAI_land_types.csv",
                     error_tolerance= 0.01)
...
compare_iso_glu_hyde_land_data(path_to_Original_LDS_Data = "../outputs/basins235_test_new_protected/Land_type_area_ha.csv",
                                  path_to_Updated_LDS_Data = "../outputs/basins235_test_new_protected/Land_type_area_ha.csv",
                                  path_to_old_mapping = "../outputs/basins235_test_new_protected/MOIRAI_land_types.csv",
                                  path_to_new_mapping = "../outputs/basins235_test_new_protected/MOIRAI_land_types.csv",
                                          error_tolerance= 0.01,
...
compare_iso_glu_sage_land_data(path_to_Original_LDS_Data = "../outputs/basins235_test_new_protected/Land_type_area_ha.csv",
                                  path_to_Updated_LDS_Data = "../outputs/basins235_test_new_protected/Land_type_area_ha.csv",
                                  path_to_old_mapping = "../outputs/basins235_test_new_protected/MOIRAI_land_types.csv",
                                  path_to_new_mapping = "../outputs/basins235_test_new_protected/MOIRAI_land_types.csv",
                                         error_tolerance= 0.01,
...
create_carbon_plots_veg_carbon_below_ground(
  fig_dir  = "carbon_plots/",
                                   ...
                                   glu_name = "Missouri_River_Basin",
                                   carbon_year = 2010,
                                   carbon_raster_file_names =c("veg_BG_carbon_wavg.bil",                                                                "veg_BG_carbon_q1.bil",                                                                             "veg_BG_carbon_median.bil",                                                                   "veg_BG_carbon_min.bil",                                                                      "veg_BG_carbon_q3.bil",                                                                         "veg_BG_carbon_max.bil"),
                                   print_raster_progress_log =FALSE
)
