...
compare_iso_land_data <- function(path_to_Original_LDS_Data = "../outputs/basins235_lulcc/Land_type_area_ha.csv",
...
compare_iso_glu_land_data<-function(path_to_Original_LDS_Data = "../outputs/basins235_lulcc/Land_type_area_ha.csv",
                     path_to_Updated_LDS_Data = "../outputs/basins235_test_new_protected/Land_type_area_ha.csv",
                     path_to_old_mapping = "../outputs/basins235_lulcc/MOIRAI_land_types.csv",
                     path_to_new_mapping = "../outputs/basins235_test_new_protected/MOIRAI_land_types.csv",
                     error_tolerance= 0.01,
...
compare_iso_glu_hyde_land_data<-function(path_to_Original_LDS_Data = "../outputs/basins235_lulcc/Land_type_area_ha.csv",
                                         path_to_Updated_LDS_Data = "../outputs/basins235_test_new_protected/Land_type_area_ha.csv",
                                         path_to_old_mapping = "../outputs/basins235_lulcc/MOIRAI_land_types.csv",
                                         path_to_new_mapping = "../outputs/basins235_test_new_protected/MOIRAI_land_types.csv",
                                          error_tolerance= 0.01,
...
compare_iso_glu_sage_land_data<-function(path_to_Original_LDS_Data = "../outputs/basins235_lulcc/Land_type_area_ha.csv",
                                         path_to_Updated_LDS_Data = "../outputs/basins235_test_new_protected/Land_type_area_ha.csv",
                                         path_to_old_mapping = "../outputs/basins235_lulcc/MOIRAI_land_types.csv",
                                         path_to_new_mapping = "../outputs/basins235_test_new_protected/MOIRAI_land_types.csv",
                                         error_tolerance= 0.01,
...
compare_iso_glu_hyde_sage_land_data<-function(path_to_Original_LDS_Data = "../outputs/basins235_lulcc/Land_type_area_ha.csv",
                                         path_to_Updated_LDS_Data = "../outputs/basins235_test_new_protected/Land_type_area_ha.csv",
                                         path_to_old_mapping = "../outputs/basins235_lulcc/MOIRAI_land_types.csv",
                                         path_to_new_mapping = "../outputs/basins235_test_new_protected/MOIRAI_land_types.csv",
                                         error_tolerance= 0.01,
