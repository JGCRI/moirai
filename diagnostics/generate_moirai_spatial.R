...
dir.create("final_vectors",showWarnings = FALSE)
...
moirai_land_raster_path <-'D:/MOIRAI_3.1_Final/moirai/ancillary/MOIRAI_shp_file/land_raster/moirai_valid_land_area.bsq'
moirai_basin_boundary_path <-"D:/MOIRAI_3.1_Final/moirai/indata/Global235_CLM_5arcmin.bil"
moirai_projection <- "+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0"
gcam_region_boundaries <-'D:/GCAM_Fd/food-demand/R/GCAM_32_w_Taiwan.shp'
...
#Remove holes
shp_file<-smoothr::fill_holes(shp_file, threshold = 10000000000000000000000000000000000)
...
#------------------------Step 3: Add metadata-------------------------------------------------
#parameters
gcam_region_name_file <- "C:/Users/kanis/OneDrive/Documents/R/win-library/3.5/gcamdata/extdata/common/GCAM_region_names.csv"
gcam_iso_reg_id_file <-  "C:/Users/kanis/OneDrive/Documents/R/win-library/3.5/gcamdata/extdata/common/iso_GCAM_regID.csv"
gcam_basin_data_file <- "C:/Users/kanis/OneDrive/Documents/R/win-library/3.5/gcamdata/extdata/water/basin_to_country_mapping.csv"
...
if(grepl("combined",file_name)){
  ...
  Final_shape_file<-smoothr::fill_holes(Final_shape_file, threshold = 1e+19)}
...
writeOGR(Final_shape_file, dsn = 'final_vectors', layer = toString(file_name), driver = "ESRI Shapefile",overwrite_layer = TRUE)
